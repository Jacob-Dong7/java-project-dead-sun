...
public class Metro extends Map {
    ...
    public void printDescription(int curr) {
        System.out.println("==================================================");
        for (int i = 0; i < metroOne.get(i).getDescription().length; ++i){ 
            System.out.println(metroOne.get(i).getDescription()[i]);
        }
        System.out.println("==================================================");
    }
            ...
            while (true) {
                if (metroOne.get(i).enemyCount() > 0) {
                    ...
                    if (userInput == 1) {
                        ...
                        playerSpeech.attemptSpeech(playerStat, 1, metroOne.get(i).enemyCount());
                    }
                } else {
